"""Regression checks for the atlas-chain-index-lab casebook."""
...
from casebook.harness import assert_expected, atlas_chain_index_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(atlas_chain_index_lab_summary(), assert_expected())
